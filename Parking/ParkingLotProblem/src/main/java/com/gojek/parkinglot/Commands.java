...
public class Commands {
    ...
    private void populateCommandsHashMap() throws NoSuchMethodException {
        ...
        commandsMap.put("registration_numbers_for_cars_with_age", ParkingLot.class.getMethod("getRegistrationNumbersFromAge", String.class));
        commandsMap.put("slot_numbers_for_cars_with_age", ParkingLot.class.getMethod("getSlotNumbersFromAge", String.class));
